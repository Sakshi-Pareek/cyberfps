        ...
        <Container>
          <div className="text-center d-md-flex flex-cloumn justify-content-center">
            <img
              src={Salona}
              alt="Salona"
              className="w-100 max_w_385 max_h_225 me-md-5 me-0 glass_hover" data-aos="zoom-in"
              data-aos-duration="300"
            />
            <img
              src={Engine}
              alt="Engine"
              className="w-100 max_w_263 max_h_225 mt-md-0 mt-sm-5 mt-4 glass_hover" data-aos="zoom-in"
              data-aos-duration="300"
            />
          </div>
        </Container>
